...
@Component({
  selector: 'app-another-universe-page',
  standalone: true,
  imports: [AppShellComponent, RouterLink],
  templateUrl: './another-universe-page.component.html',
  styleUrl: './another-universe-page.component.scss',
})
export class AnotherUniversePageComponent implements OnInit {
